...
from producer import queue_producer
...
PLATE_PATTERN = re.compile(r"[A-Z]{3}[0-9][0-9A-Z][0-9]{2}")
...
def main():
    ...
    while True:
        ...
        for i, rs in enumerate(results['results']):
            ...
            if confidence > 80 and len(plate) == 7 and PLATE_PATTERN.match(plate) is not None:
